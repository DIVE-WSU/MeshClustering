...
% NBIN.M - the NBIN binormalization algorithm
% for a general matrix A
% Input : * mxn matrix A

% * maximum number of sweeps (default = 10)
% * verbose mode flag (0=no printout,
% default; 1=printouts)
% Output : * The normalized matrix C = F*A*F
% * The row-scaling factors f = (f1...fm),
% column scaling factors g = (g1,...,gn).
TOL = 1e-10;
if (nargin < 2)
    max_iter = 100;
end
